...
public class LiveDataCallAdapterFactory extends CallAdapter.Factory {
   ...
   * check 1) returnType returns LiveData check 2) Check the Type the liveData is wrapping around,
   * LiveData<T> is of ApiResponse.class check 3) Make sure ApiResponse is
   * parameterized(ApiResponse<T>)
   */
