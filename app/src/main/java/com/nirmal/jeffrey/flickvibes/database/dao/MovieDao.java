...
public interface MovieDao {
  ...
  @Query(
      "UPDATE movie_table SET title=:title,poster_path =:posterPath,backdrop_path=:backdropPath,overview=:overView,release_date=:releaseDate,"
  ...
  //Get favorite movie list for displaying a tag on it in main activity
